[Laravel Lang](https://github.com/Laravel-Lang/lang) / [Main Page](../index.md) / [Completion Status](../status.md) / es
...
### [cashier](https://github.com/Laravel-Lang/lang/blob/master/locales/es/packages/cashier.json)
...
### [fortify](https://github.com/Laravel-Lang/lang/blob/master/locales/es/packages/fortify.json)
...
### [jetstream](https://github.com/Laravel-Lang/lang/blob/master/locales/es/packages/jetstream.json)
...
### [spark-paddle](https://github.com/Laravel-Lang/lang/blob/master/locales/es/packages/spark-paddle.json)
...
### [spark-stripe](https://github.com/Laravel-Lang/lang/blob/master/locales/es/packages/spark-stripe.json)

...
return [
    ...
    'max'                  => [
        ...
        'file'    => 'এই ফাইল অবশ্যই :value কিলোবাইটের বেশি হতে পারবে না',
        'numeric' => 'এর ভ্যালু অবশ্যই :value এর বেশি হতে পারবে না',
        'string'  => 'এটি অবশ্যই :value ক্যারেক্টারের বেশি হতে পারবে না',
    ],
    ...
    'min'                  => [
        ...
        'file'    => 'এই ফাইল অবশ্যই :value কিলোবাইটের কম হতে পারবে না',
        'numeric' => 'এর ভ্যালু অবশ্যই :value এর কম হতে পারবে না',
        'string'  => 'এটি অবশ্যই :value ক্যারেক্টারের কম হতে পারবে না',
    ],

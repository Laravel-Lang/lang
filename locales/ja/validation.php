...
return [
    ...
    'password'             => [
        'letters'       => ':attributeは文字を１文字以上含めなければなりません。',
        'mixed'         => ':attributeは大文字と小文字をそれぞれ１文字以上含めなければなりません。',
        'numbers'       => ':attributeは数字を１文字以上含めなければなりません。',
        'symbols'       => ':attributeは記号を１文字以上含めなければなりません。',
        'uncompromised' => ':attributeはデータ漏洩の対象だった可能性があります。別の:attributeを選んでください。',
    ],

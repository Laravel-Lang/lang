...
return [
    ...
    'password'             => [
        ...
        'mixed'         => ':attribute يجب أن يحتوي على الأقل حرف كبير واحد وحرف صغير واحد.',
        'numbers'       => ':attribute يجب أن يحتوي على الأقل رقم واحد.',
        'symbols'       => ':attribute يجب أن يحتوي على الأقل رمز واحد.',
        'uncompromised' => ':attribute المستخدم ضمن قائمة البيانات المسربة. الرجاء اختيار :attribute مختلف.',
    ],

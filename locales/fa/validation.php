...
return [
    ...
    'password'             => [
        'letters'       => ':attribute باید حداقل شامل یک حرف داشته باشد.',
        'mixed'         => ':attribute باید حداقل شامل یک حرف بزرگ و یک حرف کوچم باشد.',
        'numbers'       => ':attribute باید حداقل شامل یک عدد باشد.',
        'symbols'       => ':attribute باید حداقل شامل یک سمبل باشد.',
        'uncompromised' => ':attribute داده شده در یک نشت داده دیده شده است. لطفا یک :attribute دیگر انتخاب کنید.',
    ],

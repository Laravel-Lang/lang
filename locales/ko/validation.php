...
return [
    ...
    'password'             => [
        'letters'       => ':attribute은(는) 반드시 하나 이상의 문자를 포함해야합니다.',
        'mixed'         => ':attribute에는 하나 이상의 대문자와 하나의 소문자가 포함되어야 합니다.',
        'numbers'       => ':attribute은(는) 반드시 하나 이상의 숫자를 포함해야합니다.',
        'symbols'       => 'attribute은(는) 반드시 하나 이상의 특수 문자를 포함해야합니다.',
        'uncompromised' => '주어진 :attribute이(가) 데이터 누출에 나타났습니다. 다른 :attribute을(를) 선택하세요.',
    ],

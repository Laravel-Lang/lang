...
return [
    ...
    'password'             => [
        'letters'       => ':attribute অ্যাট্রিবিউটে অন্তত একটি অক্ষর থাকতে হবে ।',
        'mixed'         => ':attribute অ্যাট্রিবিউটে কমপক্ষে একটি বড় হাতের এবং একটি ছোট হাতের অক্ষর থাকতে হবে ।',
        'numbers'       => ':attribute অ্যাট্রিবিউটে অন্তত একটি নম্বর থাকতে হবে ।',
        'symbols'       => ':attribute অ্যাট্রিবিউটে অন্তত একটি চিহ্ন থাকতে হবে ।',
        'uncompromised' => 'প্রদত্ত :attribute একটি ডেটা ফাঁসে উপস্থিত হয়েছে । একটি ভিন্ন :attribute চয়ন করুন ।',
    ],

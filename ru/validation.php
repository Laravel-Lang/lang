...
return [
    ...
    */
    ...
    "after"                => "Поле :attribute должно содержать дату не ранее :date.",
    "alpha"                => "Поле :attribute может содержать только буквы.",
    "alpha_dash"           => "Поле :attribute может содержать только буквы, цифры и дефис.",
    "alpha_num"            => "Поле :attribute может содержать только буквы и цифры.",
    "array"                => "Поле :attribute должно быть массивом.",
    "before"               => "Поле :attribute должно содежрать дату не позже :date.",
    "between"              => [
    ...
    "date_format"          => "Дата в поле :attribute не соответствует формату :format.",
    "different"            => "Поля :attribute и :other должны различаться.",
    "digits"               => "Количество знаков цифрового поля :attribute должно быть равно :digits.",
    "digits_between"       => "Количество знаков цифрового поля :attribute должно быть между :min и :max.",
    ...
    "max"                  => [
        "numeric" => "Поле :attribute не может иметь значение более :max.",
        "file"    => "Размер файла в поле :attribute не должен превышать :max Килобайт(а).",

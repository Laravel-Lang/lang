...
return [
    ...
    'password'             => [
        'letters'       => ':attribute 至少包含一個字母。',
        'mixed'         => ':attribute 至少包含一個大寫和小寫字母。',
        'numbers'       => ':attribute 至少包含一個數字。',
        'symbols'       => ':attribute 至少包含一個符號。',
        'uncompromised' => ':attribute 已出現在數據泄露中。請選擇一個不同的 :attribute。',
    ],
